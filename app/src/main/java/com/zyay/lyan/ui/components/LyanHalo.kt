...
import androidx.compose.ui.unit.dp
import com.zyay.lyan.ui.theme.LyanAccent
import com.zyay.lyan.ui.theme.LyanCyan
...
fun LyanHalo(
    ...
    val transition = rememberInfiniteTransition(label = "lyan-halo")
    ...
    Box(
        modifier = modifier.drawBehind {
            ...
            val brush = Brush.linearGradient(
                colors = listOf(
                    LyanCyan.copy(alpha = alpha),
                    LyanAccent.copy(alpha = alpha * 0.85f),
