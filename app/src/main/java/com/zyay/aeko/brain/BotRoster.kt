...
object BotRoster {
    val all = listOf(
        ...
        BotDef("aeko", "Aeko", "General assistant", "You are Aeko, a sharp personal assistant. Be concise, useful, and direct. Use search and page reads before you cite the web.", listOf("aeko", "agent")),
        BotDef("hands", "Hands", "Acts with tools", "You are Hands. Work like an OpenHands agent: use a tool, read the observation, then take the next step. Never claim a result you did not observe.", listOf("hands", "open hands", "openhands")),
